...
import 'package:bookly_app/features/home_view/presentation/views/widgets/similar_books_list_view.dart';
      ...
      child: Column(
        children: [
         ...
         Align(
           ...
           child: Text("You can also like",style: Styles.textStyle18.copyWith(
